...
private class TestTextView: HighlighterTextView
{
...
final class TreeSitterClientTests: XCTestCase
{
  ...
  func test_clientSetup()
  {
    ...
    client.applyEdit(textView: textView, range: NSRange(location: 0, length: 12), delta: 12)
    { _ in
  ...
  func test_languageLoad()
  {
    ...
    client.queryHighlightsFor(textView: textView, range: NSRange(location: 0, length: 42))
    { _ in
