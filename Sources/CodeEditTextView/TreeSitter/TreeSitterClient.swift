...
public final class TreeSitterClient: HighlightProviding
{
  ...
  {
    runningTask != nil || !queuedEdits.isEmpty || !queuedQueries.isEmpty
  }
  ...
  {
    guard runningTask == nil, !queuedEdits.isEmpty || !queuedQueries.isEmpty else { return }
  ...
  private func determineNextJob() -> QueuedTaskType?
  {
    ...
    if !queuedEdits.isEmpty
    {
      return .edit(job: queuedEdits.removeFirst())
    }
    else if !queuedQueries.isEmpty
    {
