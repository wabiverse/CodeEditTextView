...
public struct CodeEditTextView: NSViewControllerRepresentable
{
  ...
  public func makeNSViewController(context _: Context) -> NSViewControllerType
  {
  ...
  public func updateNSViewController(_ controller: NSViewControllerType, context _: Context)
  {
    ...
    guard !paramsAreEqual(controller: controller)
    else
    {
      return
    }
